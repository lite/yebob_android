...
public class YebobApiActivity extends Activity {
	...
	private void addAccessTokenButton(LinearLayout layout) {
		...
		btn.setOnClickListener(new View.OnClickListener() {
		    ...
		    public void onClick(View v) {
		    	Api.accessToken(APP_ID, APP_SECRET, new Handler(){  
		    		@Override
	...
	private void addLoginButton(LinearLayout layout) {
		...
		btn.setOnClickListener(new View.OnClickListener() {
		    @Override
		    public void onClick(View v) {
		    	Api.login(token, SOCIAL_APPID, SOCIAL_APPCODE, "123", "http://alpha.yebob.com/TestYebobListRest/userlogin", new Handler(){  
		    		@Override
					public void execute(JSONObject json) throws JSONException {
		    			postLogin(json);
		    		}
	...
	private void addLogoutButton(LinearLayout layout) {
		...
		btn.setOnClickListener(new View.OnClickListener() {
		    @Override
		    public void onClick(View v) {
		    	Api.logout("token", "session", new Handler(){  
		    		@Override
					public void execute(JSONObject json) throws JSONException  {
		    			postLogout(json);
		    		}
	...
	private void addMeButton(LinearLayout layout) {
		...
		btn.setOnClickListener(new View.OnClickListener() {
		    @Override
		    public void onClick(View v) {
		    	Api.me(token, session, new Handler(){  
		    		@Override
					public void execute(JSONObject json) throws JSONException  {
		    			postMe(json);
		    		}
	...
	private void addRankingListsButton(LinearLayout layout) {
		...
		btn.setOnClickListener(new View.OnClickListener() {
		    @Override
		    public void onClick(View v) {
		    	Api.rankingLists(token, new Handler(){  
		    		@Override
					public void execute(JSONObject json) throws JSONException  {
	...
	private void addRankingTopsButton(LinearLayout layout) {
		...
		btn.setOnClickListener(new View.OnClickListener() {
		    ...
		    public void onClick(View v) {
		    	...
		    	Api.rankingTops(token, rankingListId, count, start_row, "week", "friend", new Handler(){  
		    		@Override
					public void execute(JSONObject json) throws JSONException  {
	...
	private void addStatusGetButton(LinearLayout layout) {
		...
		btn.setOnClickListener(new View.OnClickListener() {
		    @Override
		    public void onClick(View v) {
		    	Api.statusGet(token, new Handler(){  
		    		@Override
					public void execute(JSONObject json) throws JSONException  {
		    			postStatusGet(json);
		    		}
